...
$sql = mysql_query("SELECT * FROM uk WHERE id=$id1");
...
include "storescripts/connect_mysql.php";
	$sql = mysql_query("SELECT * FROM uk WHERE id=$id");
...
<a href="#" class="thumbnail" data-image-id="" data-toggle="modal" data-title="Image One" data-target="#image-gallery">
 <img src="storeimages/uk/<?php echo $img1id;?>"  alt="image not available"></img>
</a></div>
<div class="col-md-4">
<a href="#" class="thumbnail" data-image-id="" data-toggle="modal" data-title="Image Two" data-target="#image-gallery"> <img src="storeimages/uk/<?php echo $img2id;?>"  alt="image not available"></img>
</a></div>
<div class="col-md-4">
<a href="#" class="thumbnail" data-image-id="" data-toggle="modal" data-title="Image Three" data-target="#image-gallery"> <img src="storeimages/uk/<?php echo $img3id;?>"  alt="image not available"></img>
</a></div>
