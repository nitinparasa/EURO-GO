...
if(!empty($_POST['city']) && empty($_POST['categ'])){
					...
					$sql = mysql_query("SELECT * FROM italy WHERE (city='$noval' OR city='$city0' OR city='$city1' OR city='$city2' OR city='$city3')");
					...
					while($row=mysql_fetch_array($sql)){
						...
						$dynamic_list .= "<div class='col-md-4' style='border:2px solid red;'><a href='qview1.php?id=".$id."' class='iframe'>
...
elseif(!empty($_POST['categ']) && empty($_POST['city'])){
					...
					$sql = mysql_query("SELECT * FROM italy WHERE (categ='$noval' OR categ='$cat0' OR categ='$cat1' OR categ='$cat2' OR categ='$cat3')");
...
elseif(!empty($_POST['city']) && !empty($_POST['categ'])){
					...
					$sql = mysql_query("SELECT * FROM italy WHERE (city='$noval' OR city='$city0' OR city='$city1' OR city='$city2' OR city='$city3') AND (categ='$noval' OR categ='$cat0' OR categ='$cat1' OR categ='$cat2' OR categ='$cat3')");
