...
<p style="font-weight:bold;text-transform:uppercase;padding-top:23px;"><?php echo $l_name; ?> <button type="button" class="btn btn-primary" style="float:right;">ADD TO FAVOURITES</button></p>    
...
<div class="container" id="map" style="width:85%; height:300px;border:1px solid lightblue;border-radius:10px;"><p></p></div>
  ...
  <div class="container col-md-14" style="text-align:center;padding-top:15px;"> <button type="button" class="btn btn-primary" style="width:200px;height:40px;">ADD TO FAVOURITES</button> </div>
</div>
